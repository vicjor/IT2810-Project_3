...
const API_PORT = process.env.PORT || 3001; // Listening for incoming HTTP requests on port 3001
...
const dbRoute = process.env.DB_ROUTE || "mongodb://127.0.0.1:27017";
...
app.use((req, res, next) => {
	res
		.status(404)
		.send(
			"404 file not found. The information you are looking for is not here! Try a different path"
		);
});
